    ...
    *************************************************************/
    ...
    public void setPeso(float peso) throws InvalidWeightException {
        ...
        if (peso <= 0 || peso >= 500)
            ...
            throw new InvalidWeightException(peso + " nao eh valido. Peso deve ser um valor positivo (menor que 500kg.");
        this.peso = peso;
    }
    ...
    public void setAltura(float altura) throws InvalidHeightException {
        if (altura < 0.40 || altura > 2.30)
            throw new InvalidHeightException(altura + " nao eh valida. Altura deve ser um valor acima de 0.40m (menor que 2.30m).");
        this.altura = altura;
    }
